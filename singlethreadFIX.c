...
static int think_time = 50;    // amount of think time
...
void *transact(void *dummy) 
{
    ...
    for(i = 0; i < num_trans; i++) {
        ...
        int acct_id_from = rand() % num_accts; // Typo in variable name
...
int main(int argc, char **argv) 
{
    ...
    // initialize the bank accounts values and keep track of the total sum in all original accounts
    ...
    if (sum != original_sum) { // Typo in variable name
